...
export const ARQUIVOS_DADOS: readonly ArquivoDados[] = [
    ...
    },
    {
        nome: 'Sprints.json',
        tipo: 'cadastro',
        conteudo: 'Sprints cadastrados: nome, horas por dia, margem (%), datas de início e fim, dias não úteis, horas deduzidas da capacidade por colaborador e se está fechado.',
        geradoPor: 'Sprint: adicionar, editar, remover, fechar ou reabrir um sprint; Acompanhamento: horas deduzidas de um colaborador (duplo clique).',
        contemSegredo: false,
    },
    {
    ...
    },
    {
        ...
        tipo: 'configuracao',
        conteudo: 'Conexão com o Jira: URL do domínio, e-mail, API Token (criptografado) e quadros de DEV e de Análise.',
    ...
    },
    {
        ...
        tipo: 'configuracao',
        conteudo: 'Campos do Jira: estimativas de Desenvolvimento, Revisão e Testes, "Revisado por", "Analisado por", "Time", "Previsão de liberação" e a janela de alerta da previsão (dias).',
    ...
    {
        nome: 'JiraColunasDev.json',
        tipo: 'configuracao',
        conteudo: 'Cor de cada coluna do quadro de DEV do Jira usada na badge de Coluna do Planejamento.',
        geradoPor: 'Configurações → Jira: Cores: salvar.',
        contemSegredo: false,
    },
    {
        nome: 'JiraColunasAnalise.json',
        tipo: 'configuracao',
        conteudo: 'Cor de cada coluna do quadro de Análise do Jira usada na badge de Coluna do Planejamento.',
        geradoPor: 'Configurações → Jira: Cores: salvar.',
        contemSegredo: false,
    },
    {
    ...
    },
    {
        ...
        tipo: 'configuracao',
        conteudo: 'Colunas de cada quadro do Jira (DEV e Análise) que não devem aparecer no Planejamento.',
    ...
    {
        nome: 'JiraPlanejamentoGlobalDev.json',
        tipo: 'cache',
        conteudo: 'Cartões do sprint ativo do quadro de DEV do Jira (colunas, status e pessoas). Global: não depende do sprint do app.',
        geradoPor: 'Planejamento: consulta com "Jira", quadro sem planejamento salvo ou botão Atualizar no quadro Dev.',
        contemSegredo: false,
    },
    {
        nome: 'JiraPlanejamentoGlobalAnalise.json',
        tipo: 'cache',
        conteudo: 'Cartões do sprint ativo do quadro de Análise do Jira (colunas, status e pessoas). Global: não depende do sprint do app.',
        geradoPor: 'Planejamento: consulta com "Jira", quadro sem planejamento salvo ou botão Atualizar no quadro Análise.',
        contemSegredo: false,
    },
    {
    ...
    {
        nome: 'JiraColunasDevCache.json',
        tipo: 'cache',
        conteudo: 'Nomes reais das colunas do quadro de DEV do Jira, id do quadro e data da última atualização.',
        geradoPor: 'Configurações → Jira: Cores ou Jira: Quadro: ao listar ou atualizar as colunas.',
        contemSegredo: false,
    },
    {
        nome: 'JiraColunasAnaliseCache.json',
        tipo: 'cache',
        conteudo: 'Nomes reais das colunas do quadro de Análise do Jira, id do quadro e data da última atualização.',
        geradoPor: 'Configurações → Jira: Cores ou Jira: Quadro: ao listar ou atualizar as colunas.',
        contemSegredo: false,
    },
    {
