                                    ...
                                    {usuarios.map((usuario) => (
                                        <TableRow key={usuario.chave}>
                                            ...
                                            <TableCell sx={{ px: 1, whiteSpace: 'nowrap' }}>
                                                <Chip
                                                    size="small"
                                                    color={usuario.administrador ? undefined : 'error'}
                                                    label={usuario.administrador ? 'Sim' : 'Não'}
                                                    sx={usuario.administrador ? { bgcolor: CORES.accentAzul, color: CORES.creme } : undefined} />
                                            </TableCell>
