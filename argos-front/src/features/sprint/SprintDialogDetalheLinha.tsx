...
const COR_TEMPO = CORES.accentAzul;
...
export function SprintDialogDetalheLinha({
    ...
    return (
        <Dialog open={aberto} onClose={onFechar} maxWidth="md" fullWidth fullScreen={telaPequena}>
            <DialogTitle>
                <Stack spacing={0.5}>
                    <Typography
                        variant="h6"
                                        ...
                                        return (
                                            <TableCell key={grupo.rotulo} align="center">
                                                {bloco.preHoras > 0 ? (
                                                    <Typography
                                                        variant="body2"
                                                        sx={{ color: COR_TEMPO, fontWeight: 600 }}>
                                                ...
                                                {bloco.reaSegundos > 0 ? (
                                                    <Box>
                                                        <Typography
                                                            variant="body2"
                                                            sx={{
                                                                color: reaExcedePre ? COR_PENDENTE : COR_TEMPO,
                                                                fontWeight: 600,
                                                            }}>
