...
**Sprint** e **Dados**. Em telas largas ele é permanente e o botão de menu do topo o esconde/exibe (ao
...
[gerar o API Token do Jira](../argos-back/README.md#como-obter-seu-api-token-do-jira) e o **quadro de DEV** usado pelo Planejamento (seletor sobre os quadros Scrum
