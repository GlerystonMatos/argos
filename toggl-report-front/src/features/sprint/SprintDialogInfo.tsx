            ...
            <DialogContent>
                <Stack spacing={2}>
                    ...
                    <Stack spacing={0.5}>
                        ...
                        <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                            ...
                            <Typography component="li" variant="body2" color="text.secondary">
                                ...
                                colunas para ver a legenda, e nos valores para ver a hora completa. No grupo DEV,
                                PRE vem da "Estimativa de esforço" do Jira (tooltip mostra também a Estimativa
                                original); sem integração do Jira, sem a tarefa encontrada ou sem estimativa
                                configurada, PRE fica "–" — REV/QA nunca têm PRE, sempre "–". PRE e REA usam a mesma
                                cor de destaque quando têm valor; se o tempo realizado (REA) ultrapassa a estimativa
                                (PRE), o REA fica em vermelho (mesmo tom de alerta usado no resto do Sprint) e o
                                tooltip avisa o excesso — só ocorre quando há PRE real, então nunca em REV/QA.
                            </Typography>
                            <Typography component="li" variant="body2" color="text.secondary">
                    ...
                    <Stack spacing={0.5}>
                        ...
                        <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                            <Typography component="li" variant="body2" color="text.secondary">
                                O botão "Filtros" abre um filtro múltiplo por Prioridade, Status e Colaborador,
                                aplicado sobre a listagem já carregada (sem nova consulta); linhas de tag ficam fora
                                quando um filtro de Prioridade ou Status está ativo, pois não têm esses valores. Uma
                                opção já selecionada some da lista de opções e só volta quando é removida da
                                seleção. O botão "Limpar" ao lado reseta só esses três filtros.
                            </Typography>
                            <Typography component="li" variant="body2" color="text.secondary">
                            ...
                            <Typography component="li" variant="body2" color="text.secondary">
                                Clicar em qualquer ponto da linha (fora da caixa de seleção e do link do código)
                                apenas destaca essa linha visualmente — é só uma marcação de tela, não é salva em
                                lugar nenhum.
                            </Typography>
                            <Typography component="li" variant="body2" color="text.secondary">
