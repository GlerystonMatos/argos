...
export function SprintDialogInfo({ aberto, onFechar, cabecalho, categorias, responsabilidade }: SprintDialogInfoProps): ReactNode {
    ...
    return (
        <Dialog
            ...
            sx={{ '& .MuiDialog-paper': telaPequena ? {} : { width: '95vw', maxWidth: '95vw' } }}>
            <DialogTitle>Como este sprint é calculado</DialogTitle>
            <DialogContent>
                <Tabs
                    value={aba}
                    onChange={(_, valor: AbaInfo) => setAba(valor)}
                    variant="scrollable"
                    scrollButtons="auto"
                        ...
                        {cabecalho ? (
                            <Stack spacing={0.5}>
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    ...
                                    configuráveis "Concluído"/"Ignorado" (Configurações → Jira: Status, também
                                    exibidas no Resumo) — uma descrição sem status na lista
                ...
                {aba === 'categorias' ? (
                    <Stack spacing={2}>
                        ...
                        <Stack spacing={0.5}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                Nome, Horas/dia e período (Início/Fim) vêm do cadastro do sprint (lista de sprints,
                                seção Sprint do menu). Só entram no cálculo os usuários do Toggl marcados como
                                "Selecionado" (seção Toggl do menu) no momento da consulta. Tags do
                                ...
                                mapeamento Jira ↔ Toggl (usado no fallback DEV/REV abaixo) ficam na seção Configurações e
                ...
                {aba === 'prerequisitos' ? (
                    <Stack spacing={2}>
                        <Stack spacing={0.5}>
                            ...
                            <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                                <Typography component="li" variant="body2" color="text.secondary">
                                    Pelo menos um <strong>usuário do Toggl</strong> cadastrado (seção Toggl do menu),
                                    com um deles marcado como <strong>Administrador</strong> — o token desse usuário é
                        ...
                        <Stack spacing={0.5}>
                            <Typography variant="subtitle2">Fluxo de uso</Typography>
                            <Box component="ol" sx={{ m: 0, pl: 2.5 }}>
                                <Typography component="li" variant="body2" color="text.secondary">
                                    Na seção Sprint do menu, a lista de sprints permite cadastrar, editar, remover e
                                    escolher o sprint (linha marcada).
                                </Typography>
                                <Typography component="li" variant="body2" color="text.secondary">
                                    "Selecionar" abre na hora o modal de consulta, com o nome do sprint e, se o sprint
                                    estiver aberto, o seletor "Forçar nova consulta em:" (período, agrupamento, tags e
                                    status configurados ficam no Resumo e em Configurações, não mais no modal). Forçar o
                                    Toggl (opção "Toggl" ou "Ambos") pede uma confirmação extra, pois consome o limite
                                    de requisições.
                                </Typography>
                                <Typography component="li" variant="body2" color="text.secondary">
                                    "Consultar" (ou "Forçar …") executa a consulta e abre esta tela de Acompanhamento;
                                    "Voltar" retorna à lista de sprints.
                                </Typography>
                            </Box>
                        </Stack>
                        ...
                        <Stack spacing={0.5}>
                            ...
                            <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                                ...
                                <Typography component="li" variant="body2" color="text.secondary">
                                    ...
                                    com todos os campos desabilitados e sem botão "Salvar"); e o modal de consulta
                                    perde o seletor "Forçar nova consulta em:" (mostra só um aviso), rodando sempre sem
                                    forçar nada — se não houver cache salvo batendo com o período consultado, a
                                    consulta falha em vez de chamar o Toggl/Jira de verdade.
                                </Typography>
                                <Typography component="li" variant="body2" color="text.secondary">
                ...
                {aba === 'listagem' ? (
                    <Stack spacing={0.5}>
                        ...
                        <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                            <Typography component="li" variant="body2" color="text.secondary">
                                O modal de consulta (aberto ao clicar em "Selecionar" na lista de sprints) escolhe
                                o que forçar em "Forçar nova consulta em:": "Nenhum" (padrão) reaproveita
                    ...
                    <Stack spacing={0.5}>
                        ...
                        <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                            ...
                            <Typography component="li" variant="body2" color="text.secondary">
                                ...
                                disponíveis; a cor vem do mapeamento configurado em Configurações → Jira: Cores
                                por nome exato. Sem cor configurada, Prioridade cai numa
                ...
                {aba === 'controles' ? (
                    <Stack spacing={0.5}>
                        ...
                        <Box component="ul" sx={{ m: 0, pl: 2.5 }}>
                            <Typography component="li" variant="body2" color="text.secondary">
                                O botão "Filtros" abre um painel em duas linhas (em telas estreitas, empilhado em
                                uma coluna). Linha 1: busca por código/descrição (filtra a listagem já carregada sem
                                nova consulta), Prioridade e Status. Linha 2: Colaborador, Situação (DEV/REV/QA), o
                                checkbox "Inverter filtros" e o botão "Limpar". Os quatro filtros de seleção
                                (Prioridade, Status, Colaborador e Situação) são múltiplos; linhas de tag ficam fora
                                quando um filtro de Prioridade ou Status está ativo, pois não têm esses valores. Uma
                                opção já selecionada some da lista de opções e só volta quando é removida da seleção.
                            </Typography>
                            <Typography component="li" variant="body2" color="text.secondary">
                                O checkbox "Inverter filtros", ao lado do botão "Limpar" (linha 2 do painel),
                                inverte o efeito dos quatro filtros de seleção: em vez de restringir a listagem
                                ...
                                texto digitado. O botão "Limpar" reseta a busca, os quatro filtros de seleção e a inversão.
                            </Typography>
                            <Typography component="li" variant="body2" color="text.secondary">
